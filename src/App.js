...
import {
  APPROVAL_STEPS, resolveTrackerKey, isApprovalCaseType,
  makeCaseKey, parseCaseKey, caseClientName,
  getCaseStatus, getSurveyLabel,
} from "./lib/caseStatus";
  ...
  const Header = () => (
    <div style={{position:"relative",paddingBottom:12,borderBottom:"3px solid #1a4a8a",marginBottom:16,minHeight:185}}>
      ...
      <div style={{textAlign:"center",paddingTop:48}}>
        ...
        <div style={{fontSize:14,color:"#333"}}>Contact Number: 0969-4931-815 / 0991-9374-062</div>
      </div>
    </div>
  );
          ...
          {formType === "invoice" && (
            <>
              ...
              <div style={{display:"inline-block",borderTop:"1px solid #000",paddingTop:6,position:"relative"}}>
                {signature&&<img src={signature} alt="signature" style={{position:"absolute",top:-90,left:10,height:150,objectFit:"contain",mixBlendMode:"multiply"}}/>}
...
export default function EBBernasPortal() {
  ...
  // Ganoon din para sa AI Assistant: agent = sarili niyang schedules lang.
  const scopedSchedules = isAgent
    ? (schedules || []).filter(s => (s.agent || "").trim().toLowerCase() === agentName.toLowerCase())
    : schedules;
  ...
  return (
    <>
      ...
      <AIAssistant
        caseStore={scopedCaseStore}
        schedules={scopedSchedules}
        employees={allEmployeesMerged}
